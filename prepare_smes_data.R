...
## download the data from europages, from the package pastax.data

europages <- pastax.data::europages_agriculture_livestock_demo

## separate the address into two parts, with the | separator
...
vroom::vroom_write(
  ...
  fs::path(
    ...
    # here("smes_data", "company_distinct_geo_data.csv")
