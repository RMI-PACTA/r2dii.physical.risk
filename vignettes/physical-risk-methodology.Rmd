...
(e.g which physical assets are located in areas with increased risk to river
flood)
...
difference in the hazard (e.g. expected precipitation):
...
each company as well as the ownership of the asset the asset, to the portfolio:
...
couple of chunks, $0 - 0.01$ relative change, $0.01 - 0.02$ and so on. We can display
how much of the production owned by the portfolios is exposed to the low-risk
quantiles ($0 - 0.01$ relative change) compared to how much is exposed to the
high-risk quantiles. This gives us an overall estimate of how exposed the
